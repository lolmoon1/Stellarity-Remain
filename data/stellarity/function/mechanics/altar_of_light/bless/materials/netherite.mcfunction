...
execute at @p store result entity @n[type=area_effect_cloud,tag=stellarity.bless] potion_contents.effects[{id:"minecraft:fire_resistance"}].duration int 1 run scoreboard players get #time stellarity.misc
